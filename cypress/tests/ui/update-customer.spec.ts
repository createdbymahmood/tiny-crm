  ...
  it('should should update current customer', () => {
    cy.fixture('new-customer')
      ...
      .then((newCustomer: Customer) => {
        cy.visit(urlcat('/customers/:id/update', {id: newCustomer.id}));

        /* Clear previous customer name */
        cy.findByTestId(testIds.createOrUpdateCustomer.form.elements.company)
          .should('be.visible')
          .clear()
          .type(newCustomer.company);

        /* Type customer industry */
        cy.findByTestId(testIds.createOrUpdateCustomer.form.elements.industry)
          .should('be.visible')
          .clear()
          .type(newCustomer.industry);

        /* Type customer about */
        cy.findByTestId(testIds.createOrUpdateCustomer.form.elements.about)
          .should('be.visible')
          .clear()
        ...
        cy.findByTestId(
          testIds.createOrUpdateCustomer.form.elements.projects.contact,
        )
          .should('be.visible')
          .clear()
