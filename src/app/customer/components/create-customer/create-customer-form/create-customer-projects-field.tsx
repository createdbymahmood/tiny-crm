...
const endDateValidator =
  ...
  async (_: RuleObject, value?: Dayjs): Promise<undefined> => {
    ...
    const startDate: Dayjs | undefined = form.getFieldValue(startDateFieldPath);
    ...
    return (
      <React.Fragment>
        {fields.map(field => {
          ...
          const startDateFieldPath = ['projects', field.name, 'start_date'];
          ...
          return (
            <Form.Item key={field.key} required={false}>
              ...
              <Form.Item label='Contact' name={getFieldName('contact')}>
                <Input
                  {...getTestAttributes(
              ...
              <Form.Item label='Start Date' name={getFieldName('start_date')}>
                <DatePicker
              ...
              <Form.Item
                ...
                rules={[
                  {
                    validator: endDateValidator(startDateFieldPath, form),
                  },
                ]}
              >
                <DatePicker
